...
export const DEFAULT_BLOGS: BlogItem[] = [
  {
    id: "blog-1",
    title: "効率的な議事録作成と上司への報告のツボ",
    category: "ビジネス・仕事術",
    description: "若手社員向けに、会議後にすぐ役立つスマートな議事録の書き方と、上司が喜ぶ報告のタイミングについて分かりやすく解説します。",
...
`
  ...
  {
    id: "blog-2",
    title: "対立から生まれる最高のチームビルディング：物語から学ぶ信頼関係",
    category: "チームマネジメント",
    description: "勇者と魔王という絶対的な対立構造を通じて、バックグラウンドが異なるメンバーがどのように相互理解を深めるかという思考実験ブログです。",
    content: `私たちはよく、自分とは全く異なる価値観を持つ人と対局することがあります。
...
`
  ...
  {
    id: "blog-3",
    title: "図書室の片隅で、伝える言葉の選び方について考える",
    category: "コラム・雑記",
    description: "日常の中の何気ない会話に潜む、お互いの感情や思いやり。照れ隠しの言葉に隠された本音を解き明かす、等身大のエッセイです。",
